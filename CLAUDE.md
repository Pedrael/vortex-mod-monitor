...
This project is indexed by GitNexus as **vortex-mod-monitor** (877 symbols, 1787 relationships, 75 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
