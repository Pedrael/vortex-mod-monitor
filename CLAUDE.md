...
This project is indexed by GitNexus as **Event-Horizon** (8258 symbols, 20084 relationships, 403 execution flows).
...
| Work in the Build area (318 symbols) | `.claude/skills/gitnexus-area-build/SKILL.md` |
...
| Work in the Resolver area (71 symbols) | `.claude/skills/gitnexus-area-resolver/SKILL.md` |
...
| Work in the Runtime area (17 symbols) | `.claude/skills/gitnexus-area-runtime/SKILL.md` |
...
| Work in the Cluster_273 area (4 symbols) | `.claude/skills/gitnexus-area-cluster-273/SKILL.md` |
