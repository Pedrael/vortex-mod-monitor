...
This project is indexed by GitNexus as **vortex-mod-monitor** (4887 symbols, 10676 relationships, 313 execution flows).
...
| Work in the Manifest area (137 symbols) | `.claude/skills/gitnexus-area-manifest/SKILL.md` |
