...
This project is indexed by GitNexus as **Event-Horizon** (8280 symbols, 20174 relationships, 402 execution flows).
...
| Work in the Build area (323 symbols) | `.claude/skills/gitnexus-area-build/SKILL.md` |
| Work in the Manifest area (321 symbols) | `.claude/skills/gitnexus-area-manifest/SKILL.md` |
