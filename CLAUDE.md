...
This project is indexed by GitNexus as **Event-Horizon** (8239 symbols, 20032 relationships, 403 execution flows).
...
| Work in the Manifest area (327 symbols) | `.claude/skills/gitnexus-area-manifest/SKILL.md` |
| Work in the Build area (319 symbols) | `.claude/skills/gitnexus-area-build/SKILL.md` |
| Work in the Installer area (295 symbols) | `.claude/skills/gitnexus-area-installer/SKILL.md` |
| Work in the Actions area (84 symbols) | `.claude/skills/gitnexus-area-actions/SKILL.md` |
| Work in the Install area (78 symbols) | `.claude/skills/gitnexus-area-install/SKILL.md` |
...
| Work in the Cluster_264 area (5 symbols) | `.claude/skills/gitnexus-area-cluster-264/SKILL.md` |
| Work in the Cluster_263 area (4 symbols) | `.claude/skills/gitnexus-area-cluster-263/SKILL.md` |
| Work in the Cluster_269 area (4 symbols) | `.claude/skills/gitnexus-area-cluster-269/SKILL.md` |
