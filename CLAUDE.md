...
| Work in the Cluster_55 area (7 symbols) | `.claude/skills/gitnexus-area-cluster-55/SKILL.md` |
...
| Work in the Cluster_76 area (4 symbols) | `.claude/skills/gitnexus-area-cluster-76/SKILL.md` |
