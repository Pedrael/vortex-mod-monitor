...
This project is indexed by GitNexus as **vortex-mod-monitor** (2509 symbols, 5206 relationships, 216 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Manifest area (135 symbols) | `.claude/skills/generated/manifest/SKILL.md` |
| Work in the Installer area (107 symbols) | `.claude/skills/generated/installer/SKILL.md` |
| Work in the Resolver area (70 symbols) | `.claude/skills/generated/resolver/SKILL.md` |
| Work in the Install area (68 symbols) | `.claude/skills/generated/install/SKILL.md` |
| Work in the Actions area (53 symbols) | `.claude/skills/generated/actions/SKILL.md` |
| Work in the Build area (48 symbols) | `.claude/skills/generated/build/SKILL.md` |
| Work in the Errors area (20 symbols) | `.claude/skills/generated/errors/SKILL.md` |
| Work in the Pages area (12 symbols) | `.claude/skills/generated/pages/SKILL.md` |
| Work in the Cluster_17 area (11 symbols) | `.claude/skills/generated/cluster-17/SKILL.md` |
| Work in the Runtime area (6 symbols) | `.claude/skills/generated/runtime/SKILL.md` |
