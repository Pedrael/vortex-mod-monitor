...
```
READ bearing://repo/vortex-mod-monitor/context   → staleness first
```
...
4. READ bearing://repo/vortex-mod-monitor/process/{name} for each
...
```
1. READ bearing://repo/vortex-mod-monitor/clusters
2. READ bearing://repo/vortex-mod-monitor/cluster/{AreaName}
...
```
1. context({ name: "X", repo: "vortex-mod-monitor" })
...
```
1. READ bearing://repo/vortex-mod-monitor/schema  (if unfamiliar with cypher)
...
```
1. READ bearing://repo/vortex-mod-monitor/clusters   → top functional areas
2. READ bearing://repo/vortex-mod-monitor/processes  → longest / most-connected flows
