...
describe("summarizeSelfChecks", () => {
  it("counts depths and missing files across mods", () => {
    const s = summarizeSelfChecks([
      { modId: "1", modName: "a", depth: "replayed", notes: [], missing: ["x", "y"], unexplained: 0, stagedCount: 5, expectedCount: 7 },
      { modId: "2", modName: "b", depth: "containment", notes: [], missing: [], unexplained: 3, stagedCount: 2, expectedCount: 0 },
      { modId: "3", modName: "c", depth: "skipped", notes: [], missing: [], unexplained: 0, stagedCount: 0, expectedCount: 0 },
    ]);
    expect(s).toEqual({
