...
This project is indexed by GitNexus as **Event-Horizon** (8354 symbols, 20385 relationships, 401 execution flows).
...
| Work in the Cluster_270 area (5 symbols) | `.claude/skills/gitnexus-area-cluster-270/SKILL.md` |
