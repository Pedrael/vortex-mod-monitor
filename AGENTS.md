...
This project is indexed by GitNexus as **vortex-mod-monitor** (4952 symbols, 10808 relationships, 310 execution flows).
...
| Work in the Manifest area (145 symbols) | `.claude/skills/gitnexus-area-manifest/SKILL.md` |
| Work in the Pages area (116 symbols) | `.claude/skills/gitnexus-area-pages/SKILL.md` |
| Work in the Installer area (103 symbols) | `.claude/skills/gitnexus-area-installer/SKILL.md` |
...
| Work in the Cluster_85 area (4 symbols) | `.claude/skills/gitnexus-area-cluster-85/SKILL.md` |
