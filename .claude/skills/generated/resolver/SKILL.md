---
name: resolver
description: "Skill for the Resolver area of vortex-mod-monitor. 67 symbols across 13 files."
---

# Resolver

67 symbols | 13 files | Cohesion: 80%
...
| `src/core/getModsListForProfile.ts` | getActiveGameId, getActiveProfileId, getActiveProfileIdFromState, getModsForProfile, assignInstallOrder |
| `src/ui/pages/install/engine.ts` | runLoadingPipeline, checkAbort, runLoadingPipelineWithReceipt, profileExistsInState |
| `src/utils/utils.ts` | pickJsonFile, pickEhcollFile, exportDiffReport |
...
| `HomePage → GetActiveProfileIdFromState` | cross_community | 5 |
...
1. `gitnexus_context({name: "createCompareModsAction"})` — see callers and callees
