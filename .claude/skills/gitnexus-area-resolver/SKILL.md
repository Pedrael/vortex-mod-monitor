...
description: "Skill for the Resolver area of vortex-mod-monitor. 82 symbols across 16 files."
---

# Resolver

82 symbols | 16 files | Cohesion: 82%
...
| `src/core/snapshotPipeline.ts` | captureFullSnapshot, onWarn, warn |
...
| `getActiveProfileIdFromState` | Function | `src/core/getModsListForProfile.ts` | 253 |
| `getModsForProfile` | Function | `src/core/getModsListForProfile.ts` | 508 |
